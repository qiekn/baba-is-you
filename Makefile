...
baba-is-you: raylib
ifneq (,$(baba_is_you_config))
	@echo "==== Building baba-is-you ($(baba_is_you_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f baba-is-you.make config=$(baba_is_you_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f baba-is-you.make clean
